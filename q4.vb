Module Module1
    'This programme has been designed to allow the scienctist to see how the different gunpowders affect the flight of the bullet being shot.'
    ...
    'This fuction allows the user to see how random angles between the given minimum and maxium affect the time, accuracy and percentage. They can input their needed distance, velocity, material, gunpowder type to which this function will do the calculations.'
    Function Probability_of_Hits(angle_of_shot As Integer, height_of_target As Integer, distance As Integer, velocity As Double, gunpowder As String, Material As String)
        ...
        Console.WriteLine(total_time & " is the total time of all the bulltes fired from the gun in seconds.")
    ...
    End Function
    'This fuction creates the table for the results.'
    ...
    End Function
    'This fuction allows the user to input different materials, distances, gunpowders and velocities and will output the accuracy and average time taken.'
    ...
    Sub Main()
        ...
        'Values inputed to calculate the total time, average and percentage for the brown gunpowder.'
        ...
        Console.WriteLine("With use of different materials they all gave different results, from the tests done it shows that when using the wood it has the smallest avergae time but is the least accurate out of the three materials. Furthermore the titanium took the longest average time but turned out to be the most accurate and the steel feel in the middle of the wood and the titanium.")
        Console.ReadLine()
